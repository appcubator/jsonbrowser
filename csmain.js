...
(function() {
  define(['underscore', 'jquery', 'ace', './LevelView', './StringLevelView', 'util', './test-json'], function(_, $, ace, LevelView, StringLevelView, util) {
    var Manager;
    Manager = function() {
      ...
      navigateToArray = function(obj, parentObj, title, parentPath, nextLevel) {
        var firstView, ind, keys, val;
        keys = (function() {
          var _i, _len, _results;
          _results = [];
          for (ind = _i = 0, _len = obj.length; _i < _len; ind = ++_i) {
            val = obj[ind];
            _results.push(ind);
          }
          return _results;
